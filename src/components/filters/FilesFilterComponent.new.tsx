...
const filterFields: FilterFieldConfig[] = [
  ...
  },
  {
    ...
    type: "select",
    placeholder: "Select additional data to include",
    options: [
      { value: "", label: "None" },
      ...
      { value: "audio,actionItems", label: "Audio & Action Items" },
      { value: "text,speakers", label: "Text & Speakers" },
      { value: "text,actionItems", label: "Text & Action Items" },
      { value: "speakers,actionItems", label: "Speakers & Action Items" },
      { value: "audio,text,speakers", label: "Audio, Text & Speakers" },
      { value: "audio,text,actionItems", label: "Audio, Text & Action Items" },
      {
        value: "audio,speakers,actionItems",
        label: "Audio, Speakers & Action Items",
      },
      {
        value: "text,speakers,actionItems",
        label: "Text, Speakers & Action Items",
      },
      {
        value: "audio,text,speakers,actionItems",
        label: "All Additional Data",
      },
    ],
    colProps: { xs: 24, sm: 12, md: 8, lg: 6 },
  },
